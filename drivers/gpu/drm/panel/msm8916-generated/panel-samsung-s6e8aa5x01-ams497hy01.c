...
static int s6e8aa5x01_ams497hy01_on(struct s6e8aa5x01_ams497hy01 *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0xb2, 0x00, 0x0f, 0x00, 0x0f); /* AID setting *//* AOR 0% */
	dsi_dcs_write_seq(dsi, 0xb6, 0xbc, 0x0f); /* ELVSS */
	dsi_dcs_write_seq(dsi, 0xf7, 0x03); /* gamma upate */
	dsi_dcs_write_seq(dsi, 0xf7, 0x00); /* gamma upate */
	dsi_dcs_write_seq(dsi, 0xc0, 0xd8, 0xd8, 0x40); /* pentile setting */
	dsi_dcs_write_seq(dsi, 0xb8, 0x38, 0x00, 0x00, 0x60, 0x44, 0x00, 0xa8); /* swire setting */
...
static int s6e8aa5x01_ams497hy01_remove(struct mipi_dsi_device *dsi)
{
...
MODULE_DESCRIPTION("DRM driver for ss_dsi_panel_S6E8AA5X01_AMS497HY01_HD");
